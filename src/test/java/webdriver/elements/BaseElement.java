...
public abstract class BaseElement extends BaseEntity {
	...
	public List<WebElement> findElements(String path) {
		...
		public void info(WebElement element)
		{
			String info = "{";

			info += String.format("id: {0}; ",            element.getAttribute("id"));
			info += String.format("Location: {0}:{1}; ",  element.getLocation().getX(), element.getLocation().getY());
